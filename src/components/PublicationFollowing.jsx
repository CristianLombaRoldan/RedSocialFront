...
export default function PublicationFollowing() {
  ...
  /**
   * Función que se encarga de fetchear las publicaciones de los usuarios seguidos.
   ...
   * La petición se hace a "/publications/following/" con los parámetros "page" y "size" igual a 5 y "sort" igual a "createDate,desc".
